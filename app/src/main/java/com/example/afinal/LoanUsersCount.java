...
public class LoanUsersCount extends RecyclerView.Adapter<LoanUsersCount.ViewHolder> {
    Context context;
    List<Users> users;

    public LoanUsersCount(Context context, List<Users> users){
    ...
    @NonNull
    @Override
    public LoanUsersCount.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.items_table_layout, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LoanUsersCount.ViewHolder holder, int position) {
